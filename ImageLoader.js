 ...
 * コンストラクタ
 *
 *function ImageLoader(canvasId) сделать
 *
 */
...
/*
function ImageLoader(canvasId, image) {
    this.context = document.getElementById(canvasId).getContext("2d");
    this.context.drawImage(image, 0, 0);
    this.input = this.context.getImageData(0, 0, image.width, image.height);
    this.temp = this.context.createImageData(image.width, image.height);
}
*/
/*
 * 画像を取得する
